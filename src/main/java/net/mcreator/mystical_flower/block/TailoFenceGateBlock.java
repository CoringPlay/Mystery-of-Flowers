...
public class TailoFenceGateBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailo_fence_gate")
	public static final Block block = null;

	public TailoFenceGateBlock(MysticalFlowerModElements instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("tailo_fence_gate");
		}
