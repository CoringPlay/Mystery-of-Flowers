...
public class TailoLeavesBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailo_leaves")
	public static final Block block = null;

	public TailoLeavesBlock(MysticalFlowerModElements instance) {
		super(instance, 1);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0f).setLightLevel(s -> 0)
					.harvestLevel(-1).harvestTool(ToolType.HOE).setRequiresTool().notSolid());
			setRegistryName("tailo_leaves");
		}
