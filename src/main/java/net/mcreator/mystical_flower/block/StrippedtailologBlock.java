...
public class StrippedtailologBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:strippedtailolog")
	public static final Block block = null;

	public StrippedtailologBlock(MysticalFlowerModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("strippedtailolog");
		}
