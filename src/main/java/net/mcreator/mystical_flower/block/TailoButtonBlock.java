...
public class TailoButtonBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailo_button")
	public static final Block block = null;

	public TailoButtonBlock(MysticalFlowerModElements instance) {
		super(instance, 8);
	}
