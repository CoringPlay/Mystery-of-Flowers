...
public class TailoFenceBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailo_fence")
	public static final Block block = null;

	public TailoFenceBlock(MysticalFlowerModElements instance) {
		super(instance, 6);
	}
