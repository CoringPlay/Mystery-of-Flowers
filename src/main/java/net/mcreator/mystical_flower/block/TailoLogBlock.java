...
public class TailoLogBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailo_log")
	public static final Block block = null;

	public TailoLogBlock(MysticalFlowerModElements instance) {
		super(instance, 2);
	}
