...
public class TailoplanksBlock extends MysticalFlowerModElements.ModElement {
	@ObjectHolder("mystical_flower:tailoplanks")
	public static final Block block = null;

	public TailoplanksBlock(MysticalFlowerModElements instance) {
		super(instance, 4);
	}
